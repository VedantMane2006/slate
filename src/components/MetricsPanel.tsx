...
export function MetricsPanel() {
  ...
  return (
    <div 
      className="absolute top-4 right-4 bg-white/90 backdrop-blur-md shadow-lg rounded-xl border border-gray-200 text-xs font-mono text-gray-700 z-50 pointer-events-auto"
      style={{ width: isOpen ? '18rem' : 'auto' }}
      data-testid="metrics-panel"
    >
      <div 
        className={`flex justify-between items-center p-3 cursor-pointer select-none ${isOpen ? 'border-b border-gray-200 pb-2' : ''}`}
